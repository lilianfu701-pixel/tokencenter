      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="border-border shadow-none">
          ...
          <CardContent className="space-y-4">
            <textarea
              className="h-48 w-full resize-none rounded-lg border border-border bg-card p-3 text-sm text-foreground placeholder-neutral-400 outline-none focus:border-blue-400 focus:bg-white focus:ring-2 focus:ring-blue-100 transition-colors"
